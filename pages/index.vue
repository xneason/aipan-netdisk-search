    ...
    <div class="flex flex-col items-center justify-center gap-4 mt-[60px] animate-fadeIn">
      <div class="flex items-center justify-center gap-4 hover:scale-105 transition-transform duration-300">
        ...
        <div class="text-center">
          <h1 class="text-4xl text-gray-800 font-bold dark:text-white bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">PAN.SOKU.ONE</h1>
          <!-- <p class="text-gray-600 text-sm dark:text-gray-300 mt-2">搜库-聚合网盘搜索</p> -->
        </div>
      </div>
    </div>
