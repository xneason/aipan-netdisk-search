...
<template>
    <div class="py-2 h-25 fixed bottom-0 left-0 right-0 bg-white/70  backdrop-blur dark:bg-slate-800 space-y-1">
        <div class="flex flex-row items-center justify-center  gap-3">
            <a class="" href="https://github.com/xneason/aipan-netdisk-search/tree/soku">
        ...
        <p class="text-center text-[8px] sm:text-[12px] text-slate-400">
            ...
            <a class="text-blue-500 underline" href="mailto:xn.easonchan@gmail.com" title="点击留言"> 留言 </a> 告知删除。
        </p>
    </div>
</template>
<style scoped></style>